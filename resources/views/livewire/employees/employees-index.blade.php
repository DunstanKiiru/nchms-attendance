<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Manage Employees') }}</flux:subheading>
    ...
    <div>
        ...
        <a
            href="{{ route('employees.create') }}"class="cursor-pointer px-3 py-2 text-xs font-medium text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300">
            Create Employee
        </a>
    ...
    <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
        ...
        <td class="px-6 py-2 text-gray-700 dark:text-gray-400">{{ $employee->name }}</td>
        <td class="px-6 py-2 text-gray-700 dark:text-gray-400">{{ $employee->user?->email }}</td>
        <td class="px-6 py-2 space-x-1">
            <a href="{{ route('employees.show', $employee->id) }}"
                class="cursor-pointer px-3 py-2 text-xs font-medium text-white bg-teal-700 rounded-lg hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300">
                Show
            </a>
            ...
            <button wire:click='delete({{ $employee->id }})' wire:confirm='Are you sure you want to delete this Employee?'
